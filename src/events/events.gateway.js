...
var EventsGateway = function () {
    ...
    var EventsGateway = _classThis = /** @class */ (function () {
        ...
        EventsGateway_1.prototype.findAll = function (data) {
            return (0, rxjs_1.from)([1, 2, 3]).pipe((0, operators_1.map)(function (item) { return ({ event: 'events', data: item }); }));
        };
        EventsGateway_1.prototype.identity = function (data) {
    ...
    (function () {
        ...
        _findAll_decorators = [(0, websockets_1.SubscribeMessage)('events')];
        _identity_decorators = [(0, websockets_1.SubscribeMessage)('identity')];
        __esDecorate(_classThis, null, _findAll_decorators, { kind: "method", name: "findAll", static: false, private: false, access: { has: function (obj) { return "findAll" in obj; }, get: function (obj) { return obj.findAll; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _identity_decorators, { kind: "method", name: "identity", static: false, private: false, access: { has: function (obj) { return "identity" in obj; }, get: function (obj) { return obj.identity; } }, metadata: _metadata }, null, _instanceExtraInitializers);
