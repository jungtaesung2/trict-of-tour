...
var ReviewsController = function () {
    ...
    var ReviewsController = _classThis = /** @class */ (function () {
        ...
        // 리뷰 조회
        ReviewsController_1.prototype.findOne = function (reviews) {
        ...
        // }
        //리뷰 수정
        ReviewsController_1.prototype.update = function (reviewid, updateReviewDto) {
            return this.ReviewsService.update(+reviewid, updateReviewDto);
        };
        //리뷰 삭제
        ReviewsController_1.prototype.remove = function (reviewid) {
    ...
    (function () {
        ...
        _findOne_decorators = [(0, common_1.Get)()];
        _update_decorators = [(0, common_1.Patch)(':reviewid')];
        _remove_decorators = [(0, common_1.Delete)(':reviewid')];
